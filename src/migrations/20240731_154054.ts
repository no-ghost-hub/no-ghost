...
ALTER TABLE "quotes" ADD COLUMN "image_id" integer;
DO $$ BEGIN
...
ALTER TABLE "quotes" DROP COLUMN IF EXISTS "medium_caption";
...
ALTER TABLE "quotes" DROP CONSTRAINT "quotes_image_id_media_id_fk";

ALTER TABLE "quotes" ADD COLUMN "medium_caption" jsonb;
...
ALTER TABLE "quotes" DROP COLUMN IF EXISTS "image_id";
DO $$ BEGIN
